...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    agent.Account.fetchAddress().then((resp) => {
      if (resp)
        methods.reset({ ...methods.getValues(), ...resp, saveAddress: false }); //Reseting the form with the values from the server response
    });
  }, [methods]);
  ...
  return (
    //FormProvider is used to pass down the FormContext (the same like using Provider with useContext)
